...
## Training
1. Download the training datasets (DAVIS、DAVSOD、FBMS and DUTS) from [Baidu Driver](https://pan.baidu.com/s/1ZF5CWg_g2GdR3G9Xj03HzA) (PSW: V2y2) and save it at './dataset/train/'. 
...
## Testing
1. Download the testing datasets (DAVIS、DAVSOD、FBMS、SegTrack-V2 and VOS) from [Baidu Driver](https://pan.baidu.com/s/1knPUX5pYDCwgpcrC2d7EWg) (PSW: y5Hu) and save it at './dataset/test/'.
